...
Homerange_distance <- homdista::homdista(file ,"%m/%d/%y %I:%M %p", 32734, "Animal", 90, 200)
...
# Home range polygons
Homerange <- homdista::homekde(file, "%m/%d/%y %I:%M %p", 32734, "Animal", 90, 200)
st_as_sf(Homerange)
...
# Read the csv data
  ...
  # Rename the column which contains different group names
