---
title: "Home range utilization and traveled distance over time"
output:
  github_document:
    toc: true
  pdf_document: 
...
6. Converts a data frame into a move object for more detailed movement analysis
```
library(homdista)
